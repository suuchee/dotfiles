---
name: markdown
description: This skill should be used when the user asks to "create markdown", "Markdown作成", "テーブル作成", "table", "マークダウン", or mentions Markdown formatting, table creation, or document structure.
---
